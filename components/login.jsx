    ...
    >
      ...
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form>
          {state === "Sign Up" && (
            <div
              className="  mb-4 flex items-center gap-3 w-full px-10 
          ...
          <div
            className="mb-4 flex items-center gap-3 w-full px-5 
          py-2.5 rounded-full bg-[#333A5C]"
          >
          ...
          <p className="mr-20 mb-4 text-indigo-500 cursor-pointer">
            Forgot Password?
          </p>
          <button
